...
for t in range(len(tribe_dirs)):
  ...
  cc_folders = len(fnmatch.filter(os.listdir(pdf_path),'cc_*'))
  env_folders = len(fnmatch.filter(os.listdir(pdf_path),'env_*'))
  gw_folders = len(fnmatch.filter(os.listdir(pdf_path),'gw_*'))
